...
namespace FSAutomator.SimConnectInterface
{
    public class Entities
    {
        ...
        internal readonly Dictionary<string, SIMCONNECT_DATATYPE> VariableTypes = new Dictionary<string, SIMCONNECT_DATATYPE>
        {
            ...
            {"num", SIMCONNECT_DATATYPE.FLOAT64}
        };

        internal Dictionary<string, DEFINITIONS> DefineIDs = new Dictionary<string, DEFINITIONS>
        {
            {"string", DEFINITIONS.StringType},
            {"bool", DEFINITIONS.BoolType },
            {"num", DEFINITIONS.NumType}
        };

        internal Dictionary<string, string> unitCorrections = new Dictionary<string, string>
        {
            {"Feet (ft)" , "Feet"},
            {"Feet (ft)/minute" , "Feet/minute"},
            {"Pounds per square foot (psf)" , "psf"},
            {"Pound force per square foot (psf)" , "psf"},
            {"Pounds per square inch (psi)" , "psi"},
            {"Foot pound" , "foot pound"},
            {"Feet (ft) per minute" , "feet/minute"},
            {"Square feet (ft)" , "square feet"},
            {"Slugs per feet squared (Slug sqft)" , "slug sqft"},
            {"Kilo pascal" , "kilopascal"},
            {"Feet (ft) per second squared" , "feet per second squared"},
        ...
        internal enum EVENTS
        {
            ...
            CHVPP_LEFT_HAT_DOWN,
            CHVPP_AP_ALT_WING,
            MOUSE_AS_YOKE_RESUME,
            MOUSE_AS_YOKE_SUSPEND,
            ...
            SPOILERS_SET,
            SPOILERS_TOGGLE,
            INC_CONCORDE_NOSE_VISOR,
            DEC_CONCORDE_NOSE_VISOR,
            CONCORDE_NOSE_VISOR_FULL_EXT,
            CONCORDE_NOSE_VISOR_FULL_RET,
            CROSS_FEED_OPEN,
            CROSS_FEED_TOGGLE,
            CROSS_FEED_OFF,
            ...
            DECISION_ALTITUDE_MSL_DEC,
            DECISION_ALTITUDE_MSL_INC,
